...
import "../CssComponent/AboutPage.scss";
import seventy from "../imageFiles/70.png";
import smallDog from "../imageFiles/1.png";
import smallRabbit from "../imageFiles/2.png";
import payment from "../imageFiles/payment.png";
import crystal from "../imageFiles/crystal.jpg";
import jems from "../imageFiles/jems.jpg";
import prety from "../imageFiles/prety.jpg";
import {
  FaFacebookF,
  FaWhatsapp,
  FaRegUser,
    ...
    return (
      <div className="pageAbout">
        ...
        <div data-aos="fade-up" className="aboutUs">
          ...
          <p className="homeText">Home - About Us</p>
        </div>
        <div data-aos="fade-up" className="seventyDiv">
          <div className="seventyParent">
            <img src={seventy} alt="" className="seventy" />
          </div>
          <div className="seventyText">
            <p className="moreAbout">About Amber</p>

            <p>
              This is the greatest pet shop to ever exist.It is just so awesome
              in selling
              <br /> pets,there is no pets you won't see in this shop.There are
              also amazing discounts
              <br /> which cannot be found in any other petshop.some other
              benefits also include;
            </p>
            <p>
              <BsChevronDoubleRight className="doubleRight" /> There are gifts
              for periodic seasons
            </p>
            <p>
              <BsChevronDoubleRight className="doubleRight2" /> There are so
              many packages for our customers
            </p>
            <p>
              <BsChevronDoubleRight className="doubleRight3" /> deliver all
              packages where you want
            </p>
            <button className="contactButton">CONTACT US</button>
          </div>
        </div>

        <Carousel data-aos="fade-up" infiniteLoop autoPlay>
        ...
        <div className="beautifulParent">
          <div data-aos="fade-right" className="crystalParent">
            <img src={crystal} alt="" className="crystal" />
            <div className="allIconParent">
              <div className="facebookfParent">
                <FaFacebookF className="face" />
              </div>
              <div className="whatsappParent">
                <FaWhatsapp />
              </div>
              <div className="twitterParent">
                <FaTwitter />
              </div>
            ...
            <p className="ceo">Crystal Mile</p>
            <p className="ceo2">Customer</p>
          </div>
          <div data-aos="fade-in" className="jemsParent">
            <img src={jems} alt="" className="jems" />
            <div className="allIconParent2">
              <div className="facebookfParent2">
                <FaFacebookF />
              </div>
              <div className="whatsappParent2">
                <FaWhatsapp />
              </div>
              <div className="twitterParent2">
                <FaTwitter />
              </div>
              <div className="instagramParent2">
                <FaInstagram />
              </div>
            </div>
            <p className="ceo">Jems Prince</p>
            <p className="ceo2">CEO</p>
          </div>
          <div data-aos="fade-left" className="pretyParent">
            <img src={prety} alt="" className="prety" />
            <div className="allIconParent3">
              <div className="facebookfParent3">
                <FaFacebookF className="face" />
              </div>
              <div className="whatsappParent3">
                <FaWhatsapp />
              </div>
              <div className="twitterParent3">
                <FaTwitter />
              </div>
              <div className="instagramParent3">
                <FaInstagram />
              </div>
            </div>
            <p className="ceo">Prety Pairy</p>
            <p className="ceo2">Customer</p>
          </div>
        </div>
