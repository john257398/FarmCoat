...
class Faq extends Component {
  constructor(props) {
    ...
    this.state = {
      faqTextState: "0px",
      faqIcon: AiOutlinePlus,
      faqTextState2: "0px",
      faqIcon2: AiOutlinePlus,
      faqTextState3: "0px",
      faqIcon3: AiOutlinePlus,
      faqTextState4: "0px",
      faqIcon4: AiOutlinePlus,
      faqTextState5: "0px",
      faqIcon5: AiOutlinePlus,
      faqTextState6: "0px",
      faqIcon6: AiOutlinePlus,
      faqTextState7: "0px",
      faqIcon7: AiOutlinePlus,
      faqTextState8: "0px",
      faqIcon8: AiOutlinePlus,
    ...
    this.faqIconFunction = this.faqIconFunction.bind(this);
    this.faqIconFunction2 = this.faqIconFunction2.bind(this);
    this.faqIconFunction3 = this.faqIconFunction3.bind(this);
    this.faqIconFunction4 = this.faqIconFunction4.bind(this);
    this.faqIconFunction5 = this.faqIconFunction5.bind(this);
    this.faqIconFunction6 = this.faqIconFunction6.bind(this);
    this.faqIconFunction7 = this.faqIconFunction7.bind(this);
    this.faqIconFunction8 = this.faqIconFunction8.bind(this);
  ...
  faqIconFunction() {
    if (this.state.faqTextState === "0px") {
      this.setState({
        faqTextState: "80px",
        faqIcon: AiOutlineMinus,
        faqTextState2: "0px",
        faqIcon2: AiOutlinePlus,
        faqTextState3: "0px",
        faqIcon3: AiOutlinePlus,
    ...
    if (this.state.faqTextState === "80px") {
      this.setState({
        faqTextState: "0px",
        faqIcon: AiOutlinePlus,
      });
  ...
  faqIconFunction2() {
    if (this.state.faqTextState2 === "0px") {
      this.setState({
        faqTextState2: "80px",
        faqIcon2: AiOutlineMinus,
        faqTextState: "0px",
        faqIcon: AiOutlinePlus,
        faqTextState3: "0px",
        faqIcon3: AiOutlinePlus,
    ...
    if (this.state.faqTextState2 === "80px") {
      this.setState({
        faqTextState2: "0px",
        faqIcon2: AiOutlinePlus,
      });
  ...
  faqIconFunction3() {
    if (this.state.faqTextState3 === "0px") {
      this.setState({
        faqTextState3: "80px",
        faqIcon3: AiOutlineMinus,
        faqTextState2: "0px",
        faqIcon2: AiOutlinePlus,
        faqTextState: "0px",
        faqIcon: AiOutlinePlus,
    ...
    if (this.state.faqTextState3 === "80px") {
      this.setState({
        faqTextState3: "0px",
        faqIcon3: AiOutlinePlus,
      });
  ...
  faqIconFunction4() {
    if (this.state.faqTextState4 === "0px") {
      this.setState({
        faqTextState4: "80px",
        faqIcon4: AiOutlineMinus,
        faqTextState2: "0px",
        faqIcon2: AiOutlinePlus,
        faqTextState3: "0px",
        faqIcon3: AiOutlinePlus,
    ...
    if (this.state.faqTextState4 === "80px") {
      this.setState({
        faqTextState4: "0px",
        faqIcon4: AiOutlinePlus,
      });
  ...
  faqIconFunction5() {
    if (this.state.faqTextState5 === "0px") {
      this.setState({
        faqTextState5: "80px",
        faqIcon5: AiOutlineMinus,
        faqTextState6: "0px",
        faqIcon6: AiOutlinePlus,
        faqTextState7: "0px",
        faqIcon7: AiOutlinePlus,
    ...
    if (this.state.faqTextState5 === "80px") {
      this.setState({
        faqTextState5: "0px",
        faqIcon5: AiOutlinePlus,
      });
  ...
  faqIconFunction6() {
    if (this.state.faqTextState6 === "0px") {
      this.setState({
        faqTextState6: "80px",
        faqIcon6: AiOutlineMinus,
        faqTextState5: "0px",
        faqIcon5: AiOutlinePlus,
        faqTextState7: "0px",
        faqIcon7: AiOutlinePlus,
    ...
    if (this.state.faqTextState6 === "80px") {
      this.setState({
        faqTextState6: "0px",
        faqIcon6: AiOutlinePlus,
      });
  ...
  faqIconFunction7() {
    if (this.state.faqTextState7 === "0px") {
      this.setState({
        faqTextState7: "80px",
        faqIcon7: AiOutlineMinus,
        faqTextState6: "0px",
        faqIcon6: AiOutlinePlus,
        faqTextState5: "0px",
        faqIcon5: AiOutlinePlus,
    ...
    if (this.state.faqTextState7 === "80px") {
      this.setState({
        faqTextState7: "0px",
        faqIcon7: AiOutlinePlus,
      });
  ...
  faqIconFunction8() {
    if (this.state.faqTextState8 === "0px") {
      this.setState({
        faqTextState8: "80px",
        faqIcon8: AiOutlineMinus,
        faqTextState6: "0px",
        faqIcon6: AiOutlinePlus,
        faqTextState7: "0px",
        faqIcon7: AiOutlinePlus,
    ...
    if (this.state.faqTextState8 === "80px") {
      this.setState({
        faqTextState8: "0px",
        faqIcon8: AiOutlinePlus,
      });
    ...
    return (
      <div className="pageFaq">
        ...
        <div data-aos="fade-up" className="aboutUs">
          <p className="aboutText">FAQ</p>
          <p className="homeText">Home - FAQ</p>
        </div>
        <div data-aos="fade-up" className="faqTotal">
          <div className="faqParent">
            <div className="questionDiv">
              <p className="generalQuestions">GENERAL QUESTIONS</p>
            </div>
            <div className="questionAccordion">
              <div className="faqIconParent" onClick={this.faqIconFunction}>
                <p className="faqTopic">
                  How do i figure out the cubic feet of my shipment?
                </p>
                <this.state.faqIcon className="faqIcon" />
              </div>
              <div
                className="faqIconText"
                style={{ maxHeight: this.state.faqTextState }}
              >
                <p>
                  Nulla imperdiet odio tempor nisl vulputate scelerisque. Fusce
                  interdum ultricies convallis. Vivamus efficitur purus eu elit
                  scelerisque blandit. Nullam viverra est quis erat fringilla,
                  at rutrum sem lacinia.
                </p>
              </div>
            </div>
            <div className="questionAccordion2">
              <div className="faqIconParent2" onClick={this.faqIconFunction2}>
                <p className="faqTopic2">How do i ship my automobile?</p>
                <this.state.faqIcon2 className="faqIcon2" />
              </div>
              <div
                className="faqIconText2"
                style={{ maxHeight: this.state.faqTextState2 }}
              >
                <p>
                  Nulla imperdiet odio tempor nisl vulputate scelerisque. Fusce
                  interdum ultricies convallis. Vivamus efficitur purus eu elit
            ...
            <div className="questionAccordion3">
              <div className="faqIconParent3" onClick={this.faqIconFunction3}>
                <p className="faqTopic3">Is my shipment insured?</p>
                <this.state.faqIcon3 className="faqIcon3" />
              </div>
              <div
                className="faqIconText3"
                style={{ maxHeight: this.state.faqTextState3 }}
              >
                <p>
                  Nulla imperdiet odio tempor nisl vulputate scelerisque. Fusce
                  interdum ultricies convallis. Vivamus efficitur purus eu elit
                  scelerisue blandit. Nullam viverra est quis erat fringilla, at
                  rutrum sem lacinia.
                </p>
              </div>
            </div>
            <div className="questionAccordion4">
              <div className="faqIconParent4" onClick={this.faqIconFunction4}>
                <p className="faqTopic4">
                  How long does it take my shipment to reach my customer?
                </p>
                <this.state.faqIcon4 className="faqIcon4" />
              </div>
              <div
                className="faqIconText4"
                style={{ maxHeight: this.state.faqTextState4 }}
              >
                <p>
                  Nulla imperdiet odio tempor nisl vulputate scelerisque. Fusce
                  interdum ultricies convallis. Vivamus efficitur purus eu eit
                  scelerisque blandit. Nullam viverra est quis erat fringilla,
                  at rutrum sem lacinia.
                </p>
              </div>
          ...
          <div className="faqParent2">
            <div className="questionDiv2">
              <p className="generalQuestions2">PURCHASING QUESTIONS</p>
            </div>
            <div className="questionAccordion5">
              <div className="faqIconParent5" onClick={this.faqIconFunction5}>
                <p className="faqTopic5">Before you get started</p>
                <this.state.faqIcon5 className="faqIcon5" />
              </div>
              <div
                className="faqIconText5"
                style={{ maxHeight: this.state.faqTextState5 }}
              >
                <p>
                  Nulla imperdiet odio tempor nisl vulputate scelerisque. Fusce
                  interdum ultricies convallis. Vivamus efficitur purus eu elit
            ...
            <div className="questionAccordion6">
              <div className="faqIconParent6" onClick={this.faqIconFunction6}>
                <p className="faqTopic6">Compatibility with premium plugins</p>
                <this.state.faqIcon6 className="faqIcon6" />
              </div>
              <div
                className="faqIconText6"
                style={{ maxHeight: this.state.faqTextState6 }}
              >
                <p>
                  Nulla imperdiet odio tempor nisl vulputate scelerisque. Fusce
                  interdum ultricies convallis. Vivamus efficitur purus eu elit
            ...
            <div className="questionAccordion7">
              <div className="faqIconParent7" onClick={this.faqIconFunction7}>
                <p className="faqTopic7">Install theme demo contents</p>
                <this.state.faqIcon7 className="faqIcon7" />
              </div>
              <div
                className="faqIconText7"
                style={{ maxHeight: this.state.faqTextState7 }}
              >
                <p>
                  Nulla imperdiet odio tempor nisl vulputate scelerisque. Fusce
                  interdum ultricies convallis. Vivamus efficitur purus eu elit
            ...
            <div className="questionAccordion8">
              <div className="faqIconParent8" onClick={this.faqIconFunction8}>
                <p className="faqTopic8">
                  Translation and localization services
                </p>
                <this.state.faqIcon8 className="faqIcon8" />
              </div>
              <div
                className="faqIconText8"
                style={{ maxHeight: this.state.faqTextState8 }}
              >
                <p>
                  Nulla imperdiet odio tempor nisl vulputate scelerisque. Fusce
                  interdum ultricies convallis. Vivamus efficitur purus eu eit
