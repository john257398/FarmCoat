...
import "../CssComponent/RegisterPage.scss";
    ...
    return (
      <div className="pageRegister">
        ...
        <div data-aos="fade-up" className="aboutUs">
          <p className="aboutText">CREATE ACCOUNT</p>
          <p className="homeText">Home - Create Account</p>
        </div>

        <div data-aos="flip-up" className="registerDiv">
          <h1 className="registerHeader">Create Account</h1>
          <div className="firstNameParent">
            {" "}
          ...
          <div className="emailParent">
            {" "}
            <input type="email" className="emaile" placeholder="Email" />
          </div>
          ...
          <div className="buttonParentReg">
            <button className="registerButton">CREATE</button>
            <p className="haveAccount">
              Have an Account? <span className="haveAccountChild">Sign in</span>
            </p>
          </div>
        </div>
